...
#Local files
from parameters.ege_model import GeothermalEnhancedModel
from parameters.ege_klausen import parameters
...
gt_model = GeothermalEnhancedModel()

#Choose demand
_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, electricity_prod_enh = lookup_geothermal()
demand = {electricity_prod_enh: 1}
...
name= "ege_sa_indices_N" + str(N) + ".xlsx"
